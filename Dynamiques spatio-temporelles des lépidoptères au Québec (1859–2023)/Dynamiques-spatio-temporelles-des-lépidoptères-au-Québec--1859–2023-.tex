...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.4\textheight]{fig_nb_esp_obs_première_fois.png}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.4\textheight]{fig_nb_esp_obs_dernière_fois.png}
