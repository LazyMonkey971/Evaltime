...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.4\textheight]{~/Desktop/nb esp obs par decennie.png}
\caption{Nombre d'espèces de papillons observées par décennie au Québec}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.4\textheight]{~/Desktop/fig nb esp obs première fois.png}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.4\textheight]{~/Desktop/fig nb esp obs dernière fois.png}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.4\textheight]{~/Desktop/nb obs par decennie.jpeg}
\caption{Nombre d'observations par décennie au Québec}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.4\textheight]{~/Desktop/nb esp par latitude.png}
\caption{Nombre d'espèces de papillons par classe de latitude au Québec}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.4\textheight]{~/Desktop/Carte.png}
